...
export const getServerSideProps = wrapper.getServerSideProps(
  (store) =>
    async ({ req, res, ...etc }) => {
      ...
      if (session) {
        isValid = await checkSession({ session, dispatch });
      }
      return {
...
const Home = (props: any) => {
  ...
  return (
    <>
      <Head>
        <title>Sitaan Besti | Login</title>
      ...
      <div className="flex w-screen h-screen">
        ...
        <div
          className={`bg-green-400 text-white lg:block fixed w-full h-full lg:h-auto lg:relative lg:w-fit -z-10 lg:m-3 p-3 shadow-lg transition-all lg:rounded-3xl ${
            focus ? "blur-xl" : "blur-0"
          }`}
        >
          <Image
            src={"/sitaan-besti.jpg"}
            alt="login-images"
