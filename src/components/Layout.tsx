  ...
  return (
    <main className="bg-white">
      ...
      <div className="min-h-screen w-full border-l grow flex flex-col overflow-hidden">
        <div className="bg-blue-400 md:pb-20 pb-10 pt-24">
          <h1 className="text-center text-5xl font-bold text-white mb-5">
            Portal Balik
          </h1>
          <div className="flex gap-5 justify-center items-center flex-col xl:flex-row">
            <AdminCard
              header="Total Barang"
              data={barang.length}
            ...
            <AdminCard
              ...
              data={
                jenisBarang.filter((item) => item.kondisi === "rusak").length
              }
            ...
            <AdminCard
              ...
              data={
                jenisBarang.filter((item) => item.kondisi === "service").length
              }
            ...
            <AdminCard
              header="Kondisi Baik"
              data={
                jenisBarang.filter((item) => item.kondisi === "baik").length
              }
