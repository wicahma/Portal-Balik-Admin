...
const Layout = ({ children }: LayoutInterface) => {
  ...
  return (
    <main className="bg-white">
      <Head>
        <title>Sitaan Besti | Dashboard</title>
      ...
      <Loading />
      <Sidebars />
      <div className="min-h-screen w-full border-l grow flex flex-col overflow-hidden p-2">
        <div className="bg-white md:pb-5 md:pt-72 pb-10 pt-16 relative overflow-hidden rounded-2xl">
          <Image
            src={"/banner.png"}
            alt="login-images"
            className="object-contain w-full top-0 absolute rounded-2xl"
            height={500}
            width={1500}
          />
